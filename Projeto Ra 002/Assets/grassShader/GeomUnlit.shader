    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            void geom(triangle v2g i[3],inout TriangleStream<g2f> triStream)
            {
                ...
                {
                    int aga = (var * sin(20)*_Time) % 4;
                o.uv = i[0].uv;
                o.vertex = i[0].vertex;
                o.normal = i[0].normal;// +float4(1, 5, 5, 1);
                o.color = i[0].color;
                triStream.Append(o);

                o.uv = i[1].uv;
                o.vertex = i[1].vertex *float4(aga, aga, 0, 1);
                o.normal = i[1].normal;// +float4(1, 5, 5, 1);
                o.color = i[1].color;// +float4(5, 5, var, 1);
                triStream.Append(o);

                o.uv = i[2].uv;
                o.vertex = i[2].vertex;// / float4(0.1, 0.1, 0.1, 1);
                o.normal = i[2].normal;// +float4(1, 5, 5, 1);
                o.color = i[2].color;
                triStream.Append(o);
                }
